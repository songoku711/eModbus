 ...
 * is ready to answer network requests it must then call eMBMasterEnable() to activate
 ...
 * while (1)
 * {
 *     // Call the main polling loop of the Modbus Master transmit main function.
 *     eMBMasterMainFunctionTx();
 * 
 *     // Call the main polling loop of the Modbus Master receive main function.
 *     eMBMasterMainFunctionRx();
 *     ...
 * }
 *
 ...
 *   eMBRegInputCB( ).
 */
typedef enum _eMB_RegisterModeType
{
  MB_REG_READ,                                    /*!< Read register values and pass to protocol stack. */
  MB_REG_WRITE                                    /*!< Update register values. */
} eMB_RegisterModeType;
...
} eMBMaster_ReqErrCodeType;
#endif



typedef struct _eMB_ElementCfgStruct
{
  eMBMode                     mode;
} eMB_ElementCfgStruct;
